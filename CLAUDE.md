...
- **주 도메인**: https://moa365.com (apex) + https://www.moa365.com (Cloudflare DNS, Vercel 호스팅)
- **보조 도메인**: https://moa.atm.ai.kr (기존, 유지)
- **백엔드**: https://atm-ledger.onrender.com (Render Hobby + Postgres)

CORS/OAuth/Maps referer 모두 두 도메인 + Vercel preview 도메인까지 허용.
비밀번호 재설정 등 이메일 링크는 moa365.com 으로 통일.

---

## 1. 프로젝트 개요

**Moa AI 가계부** — 대화하듯 기록하고 한 달을 회고하는 개인 가계부 SaaS.
