...
# 우선순위: i18n 지원 17개 언어가 자연스럽게 매핑되는 국가 위주 — 30개국 모두 native 매칭.
...
COUNTRIES: list[dict] = [
    ...
    {"code": "DE", "name_ko": "독일",           "name_en": "Germany",         "currency": "EUR", "locale": "de"},
    {"code": "FR", "name_ko": "프랑스",         "name_en": "France",          "currency": "EUR", "locale": "fr"},
    {"code": "ES", "name_ko": "스페인",         "name_en": "Spain",           "currency": "EUR", "locale": "es"},
    {"code": "IT", "name_ko": "이탈리아",       "name_en": "Italy",           "currency": "EUR", "locale": "it"},
    {"code": "NL", "name_ko": "네덜란드",       "name_en": "Netherlands",     "currency": "EUR", "locale": "nl"},
    {"code": "MX", "name_ko": "멕시코",         "name_en": "Mexico",          "currency": "MXN", "locale": "es"},
    {"code": "AR", "name_ko": "아르헨티나",     "name_en": "Argentina",       "currency": "ARS", "locale": "es"},
    {"code": "BR", "name_ko": "브라질",         "name_en": "Brazil",          "currency": "BRL", "locale": "pt"},
    ...
    {"code": "ID", "name_ko": "인도네시아",     "name_en": "Indonesia",       "currency": "IDR", "locale": "id"},
    ...
    {"code": "AE", "name_ko": "아랍에미리트",   "name_en": "United Arab Emirates", "currency": "AED", "locale": "ar"},
    {"code": "SA", "name_ko": "사우디아라비아", "name_en": "Saudi Arabia",    "currency": "SAR", "locale": "ar"},
    {"code": "ZA", "name_ko": "남아프리카공화국", "name_en": "South Africa",  "currency": "ZAR", "locale": "en"},
    {"code": "CH", "name_ko": "스위스",         "name_en": "Switzerland",     "currency": "CHF", "locale": "de"},
    {"code": "SE", "name_ko": "스웨덴",         "name_en": "Sweden",          "currency": "SEK", "locale": "sv"},
]
