  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 pt-8 pb-3 flex items-center gap-2">
        <Wallet className="w-4 h-4 text-record" />
        <h3 className="text-sm font-bold text-ink">{monthLabel}</h3>
      </div>

      <div className="px-3 pb-3">
        <div className="bg-surface border border-line rounded-2xl p-3 space-y-2.5">
          ...
          <div className="flex items-center justify-between">
            <span className="flex items-center gap-1.5 text-[10px] text-ink-tertiary">
              <ArrowUpRight className="w-3 h-3 text-record" />
              지출
            </span>
            <span className="font-mono text-[12px] text-record font-bold">-{spent}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="flex items-center gap-1.5 text-[10px] text-ink-tertiary">
              <Wallet className="w-3 h-3 text-ink" />
              저축
            </span>
            <span className="font-mono text-[12px] text-ink font-bold">-{saved}</span>
          </div>
          <div className="h-px bg-sunken" />
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono tracking-[0.18em] uppercase text-ink-tertiary">
              자유롭게 쓸 돈
            </span>
            <span className="font-mono text-base text-ink font-bold">{free}</span>
          </div>
        </div>
      </div>
